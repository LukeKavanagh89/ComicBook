...
namespace ComicStore.Controllers
{
    public class CreatorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CreatorId,Name,Age,Established")] Creator creator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CreatorId,Name,Age,Established")] Creator creator)
        {
            if (ModelState.IsValid)
            {
